...

{
 ...
 static UnsignedChar switch_0 = 0x55U;
 static UnsignedChar switch_1 = 0x55U;
 static UnsignedChar switch_2 = 0x55U;
 static UnsignedChar switch_3 = 0x55U;
 static UnsignedChar switch_4 = 0x55U;
 static UnsignedChar switch_5 = 0x55U;
 static UnsignedChar switch_6 = 0x55U;
 static UnsignedChar switch_7 = 0x55U;
 UnsignedChar test_switch;
 UnsignedChar return_value = 0U;
 ...
 switch( state )
 {
  ...
  case KEY_STATE_NO_KEY:
   ...
   test_switch = 0U;
   if( switch_0 == 0U ) ++test_switch;
   if( switch_1 == 0U ) ++test_switch;
   if( switch_2 == 0U ) ++test_switch;
   if( switch_3 == 0U ) ++test_switch;
   if( switch_4 == 0U ) ++test_switch;
   if( switch_5 == 0U ) ++test_switch;
   if( switch_6 == 0U ) ++test_switch;
   if( switch_7 == 0U ) ++test_switch;
