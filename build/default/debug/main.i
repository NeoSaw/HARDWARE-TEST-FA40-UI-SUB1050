...
# 894 "./mcc_generated_files/system/../system/pins.h"
...
# 39 "./mcc_generated_files/system/../i2c_client/mssp1.h"
# 1 "./mcc_generated_files/system/../i2c_client/i2c_client_interface.h" 1
# 47 "./mcc_generated_files/system/../i2c_client/i2c_client_interface.h"
# 1 "./mcc_generated_files/system/../i2c_client/i2c_client_types.h" 1
# 43 "./mcc_generated_files/system/../i2c_client/i2c_client_types.h"
typedef enum
{
...
# 48 "./mcc_generated_files/system/../i2c_client/i2c_client_interface.h" 2
# 58 "./mcc_generated_files/system/../i2c_client/i2c_client_interface.h"
...
# 40 "./mcc_generated_files/system/../i2c_client/mssp1.h" 2
# 61 "./mcc_generated_files/system/../i2c_client/mssp1.h"
extern const struct I2C_CLIENT_INTERFACE I2C1_Client;
# 71 "./mcc_generated_files/system/../i2c_client/mssp1.h"
void I2C1_Initialize(void);
# 80 "./mcc_generated_files/system/../i2c_client/mssp1.h"
void I2C1_Deinitialize(void);
# 89 "./mcc_generated_files/system/../i2c_client/mssp1.h"
void I2C1_WriteByte(uint8_t wrByte);
# 98 "./mcc_generated_files/system/../i2c_client/mssp1.h"
uint8_t I2C1_ReadByte(void);
# 107 "./mcc_generated_files/system/../i2c_client/mssp1.h"
uint16_t I2C1_ReadAddr(void);
# 120 "./mcc_generated_files/system/../i2c_client/mssp1.h"
i2c_client_error_t I2C1_ErrorGet(void);
# 131 "./mcc_generated_files/system/../i2c_client/mssp1.h"
i2c_client_transfer_dir_t I2C1_TransferDirGet(void);
# 142 "./mcc_generated_files/system/../i2c_client/mssp1.h"
i2c_client_ack_status_t I2C1_LastByteAckStatusGet(void);
# 151 "./mcc_generated_files/system/../i2c_client/mssp1.h"
void I2C1_CallbackRegister(_Bool (*callback)(i2c_client_transfer_event_t clientEvent));
# 160 "./mcc_generated_files/system/../i2c_client/mssp1.h"
void I2C1_ISR(void);
# 169 "./mcc_generated_files/system/../i2c_client/mssp1.h"
...
# 1 "./mcc_generated_files/system/../peripheral/tmr0.h" 1
# 22 "./mcc_generated_files/system/../peripheral/tmr0.h"
void TMR0_Initialize(void);
void TMR0_ISR(void);
# 49 "./mcc_generated_files/system/system.h" 2
# 1 "./mcc_generated_files/system/../peripheral/tmr1.h" 1
# 22 "./mcc_generated_files/system/../peripheral/tmr1.h"
...
uint16_t ui_irsensor = 0;



uint16_t sum = 0U;
uint16_t ir_filter_buffer[8U] = {0U};
uint8_t ir_filter_index = 0U;
uint16_t ui_irsensor_filtered = 0U;



static uint8_t led12_state = 0U;
    ...
    while(1)
    {
        if( flagMAIN1mSTimer )
        {
            ...
            else
            {
                ...
                ir_filter_index = (ir_filter_index + 1) % 8U;
            ...
            if( key ) {
                switch( key ) {
                    case 1U:
                        ...
                        i2cDat.st.SwitchStatus0_7.SW00 = 1;
                        break;
                    case 2U:

                        i2cDat.st.SwitchStatus0_7.SW01 = 1;
                        break;
                    case 3U:

                        i2cDat.st.SwitchStatus0_7.SW02 = 1;
                        break;
                    case 4U:

                        i2cDat.st.SwitchStatus0_7.SW03 = 1;
                        break;
                    case 5U:

                        i2cDat.st.SwitchStatus0_7.SW04 = 1;



                        led12_state = (led12_state + 1) % 3;
                    ...
                    case 6U:
                        ...
                        i2cDat.st.SwitchStatus0_7.SW05 = 1;
                        break;
                    case 7U:

                        i2cDat.st.SwitchStatus0_7.SW06 = 1;
                        break;
                    case 0U:
...
void WDT_a( void )
{
 if( intMAINWatchdog != 0x5555U ) __asm("RESET");
 intMAINWatchdog += 0x1111U;
}

void WDT_b( void )
{
 if( intMAINWatchdog != 0x8888U ) __asm("RESET");
